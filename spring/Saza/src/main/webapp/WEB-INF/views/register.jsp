...
<body>
    ...
    <div class="container py-5">
        <div class="row">
            ...
            <div class="col-lg-9" > <!-- 내용 가운데로  -->
            
            <h3 style="margin-bottom:45px; margin-top:5px;">상품 등록</h3>
           ...
           <!--  <div style="margin-top:10px; margin-left:500px;">-->
            <div class="col-md-4"><!-- 이거없애면 넓게 가능  -->
					...
					<form action="presister"  method="post" autocomplete="off" enctype="multipart/form-data" name="resisterform">
           ...
           <div class="cate_wrap">
			...
			<div class="cate_wrap">
				...
				<select class="cate3" name="cateCode">
					...
					<input type="text" id="gdsname" name="gdsname" placeholder="상품명" style="margin-top:15px;" />
					<br>
					
			
					<input type="text" id="gdsprice" name="gdsprice" placeholder="상품가격" style="margin-top:15px;"/>
					
					<div class="form_section_title">
                    				
                    			</div>
                    			<div class="form_section_content">
                    				<input name="gdsStock" placeholder="상품재고" style="margin-top:15px;"/>
                    			</div>
					<br>
					<input type="file" id="gdsfile" name="gdsfile" style="margin-top:15px;"/>
				
					<br>
					<textarea rows="5" cols="50" id="gdsdetal" name="gdsdetal" style="margin-top:15px;" placeholder="내용을 입력하세요."></textarea>
					<br>
			

				
					<button type="submit" id="register_Btn" class="btn btn-warning btn-block" style="margin-top:15px;">등록</button>
				    <button type="submit" class="btn btn-outline-success btn-block" style="margin-top:15px;"> 취소 </button>
				    </form>
