            ...
            <div class="col-lg-9">
                <div class="row">
                    <div class="col-md-6">
                                ...
                                <h3 >비밀번호 확인</h3>
                                <span style="font-weight: bold;">본인확인을 위해 비밀번호를 한 번 더 입력해 주세요.</span>
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="mpassword" id="pww" placeholder="비밀번호 입력"><br>
                        <input type="button" value="확인"  onclick="secessionfn()" style="margin-top:20px;">
                        <input type="button" value="취소" onclick="before()" style="margin-top:20px;">
