...
<body>
    ...
    <div class="container py-5">
				   ...
				   <c:if test="${sessionScope.loginMember eq 'admin'}">
                     <li class="pb-3">
                        <a class="collapsed d-flex justify-content-between h3 text-decoration-none" href="#">
                            ...
                            <li><a class="text-decoration-none" href="registerpage"> 상품 등록 </a></li>
                            <li><a class="text-decoration-none" href="#">Sweather</a></li>
                            <li><a class="text-decoration-none" href="#">Sunglass</a></li>
		...
		<c:forEach var="product" items="${productList}">
			<tr>
				<td>${product.gdscode}</td>
				<td>
					<a href="productview?gdscode=${product.gdscode}">${product.gdsname}</a>
				</td>
				<td>${product.gdsimg}</td>
				<td>${product.gdsprice}</td>
				<td>${product.gdsdetal}</td>
			</tr>
		</c:forEach>
	</table>
