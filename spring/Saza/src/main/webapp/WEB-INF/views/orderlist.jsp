					...
					<table class="order_table">
						...
						<c:forEach items="${list}" var="list">
							<tr>
								...
								<form action="delivery" method="post" class="deliveryForm">

										<input type="hidden" name="orderId" value="${list.orderId}" /> 
										<input type="hidden" name="orderState" class="orderState" value="" />
										<input type="text" name="trackingNum" placeholder="운송장 번호"/>

										
										<input type="button" class="delivery_btn" value="배송완료">

										
									</form>
									</c:if>
									
									<c:if test="${list.orderState == '배송완료' }"><br>
									운송장 번호 : ${list.trackingNum}
